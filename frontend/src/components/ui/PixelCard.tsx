...
const VARIANTS = {
  ...
  // Custom platform variant with NexTalk theming
  nextalk: {
    activeColor: '#7C3AED',
    gap: 8,
    speed: 40,
    colors: '#4C1D95,#7C3AED,#A78BFA,#2E1065',
    noFocus: false
  }
};
...
export default function PixelCard({ 
  ...
  return (
    ...
    >
      <canvas className="w-full h-full block absolute inset-0 z-0 pointer-events-none" ref={canvasRef} />
