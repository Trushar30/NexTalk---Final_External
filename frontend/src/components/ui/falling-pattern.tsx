...
export function FallingPattern({
	...
	// Create an explicit pattern background if transparent color doesn't work well
	const radialPatternBg = backgroundColor === 'transparent' ? 'transparent' : backgroundColor;
		...
		<div className={cn('relative h-full w-full p-1 overflow-hidden', className)}>
			...
			<div
				...
				style={{
					...
					backgroundImage: `radial-gradient(circle at 50% 50%, ${radialPatternBg} 0, ${radialPatternBg} 2px, transparent 2px)`,
